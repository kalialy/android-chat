...
public class ConferenceInviteMessageContentViewHolder extends NormalMessageContentViewHolder {
    ...
    void joinConference() {
       ...
       AVEngineKit.CallSession session =  AVEngineKit.Instance().joinConference(inviteMessageContent.getCallId(), inviteMessageContent.isAudioOnly(), inviteMessageContent.getPin(), inviteMessageContent.getHost(), inviteMessageContent.getTitle(), inviteMessageContent.getDesc(), inviteMessageContent.isAudience(), inviteMessageContent.isAdvanced(), false, false, null);
        session.setUseExternalVideoSource(true);
